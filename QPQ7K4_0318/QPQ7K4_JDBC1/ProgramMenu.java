...
public class ProgramMenu{
    ...
    //a metódus ellenörzi a biztos szám beolvasását
    ...
    private static boolean readBool(Scanner sc, String prompt){
        while ( true){
            ...
            System.out.println("Hibás érték, próbáld újra! (true/false)");
        }
    }
    ...
    public static void main(String[] args) {
        ...
        while (running) {
            ...
            System.out.println("2 - Oszlop összege és átlaga - task_b");
            ...
            switch (choice) {
                case 1:{
                    String tablaA = readText(sc, "Tábla neve: ");
                    ListingMethods.task_a(tablaA);
                    break;
                }
                case 2:{
                    String tablaB = readText(sc, "Tábla neve: ");
                    String column = readText(sc, "Oszlop neve: ");
                    ListingMethods.task_b(tablaB, column);
                    break;
                }
                case 3:{
                    String tablaC = readText(sc, "Tábla neve:");
                    String order = readText(sc, "Rendezési oszlop: ");
                    boolean asc = readBool(sc, "Növekvő sorrend? (true/false): ");
                    ListingMethods.task_c(tablaC, order, asc);     // ← correct name
                    break;
                }
                case 4:{
                ...
                case 5:{
                    ...
                    if (t == 1) ListingMethods.listTable("Hallgato");
                        else if (t == 2) ListingMethods.listTable("Project");
